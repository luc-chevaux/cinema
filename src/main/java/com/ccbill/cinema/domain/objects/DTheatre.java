...
public class DTheatre implements Serializable {
	...
	public DTheatre(int theatreId, int theatreShowsNumber, int theatreRows,	int theatreColumns, String theatreName) {
		super();
